...
$$
\begin{align*}
\sum^N_{i = 1} (y_i - \alpha) &= 0 \\
\sum^N_{i = 1} y_i - N \alpha &= 0 \\
N \alpha &= \sum^N_{i = 1} y_i \\
\alpha &= \dfrac{\sum^N_{i = 1} y_i}{N} = \mu
\end{align*}
$$
...
$$
\begin{align*}
\dfrac{d}{d \lambda} \sum^{N}_{i = 1} (y_i - \lambda)^2 &= 0 \\
-2 \sum^{N}_{i = 1} (y_i - \lambda) &= 0 \\
\lambda = \dfrac{\sum^{N}_{i = 1} y_i}{N}
\end{align*}
$$
...
$$
\begin{align*}
\dfrac{\partial f}{\partial \beta_0} &= -2 \sum (y_i - \beta_0 - \beta_1 x_i) = 0 \\
\dfrac{\partial f}{\partial \beta_1} &= -2 \sum x_i (y_i - \beta_0 - \beta_1 x_i) = 0
\end{align*}
$$
